...
possible_arguments="simLinRegrOnce, lwLinRegrOnce, mhLinRegrOnce, simLinRegr, lwLinRegr, mhLinRegr, smcLinRegr, rmsmcLinRegr, pmmhLinRegr, simSIR, simSIRS, simSIRSV, mhSIR, simLogRegrOnce, lwLogRegrOnce, mhLogRegrOnce, simLogRegr, lwLogRegr, mhLogRegr, simHMM, lwHMM, mhHMM, simLDA, mhPredLDA, simRadon, mhRadon, mhPredRadon, mhSchool, simGMM, mhGMM"
