...
parseArgs cmd = case cmd of
  ...
  "isviLinRegr"         -> sampleIOFixed (isviLinRegr 2000 40 8) >>= printThenWrite
  ...
  "isviHMM"             -> sampleIOFixed (isviHMM 1000 100 20) >>= printThenWrite
  ...
  "isviLDA"             -> sampleIOFixed (isviLDA 200 20 50) >>= printThenWrite
