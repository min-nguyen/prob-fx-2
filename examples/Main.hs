...
parseArgs cmd = case cmd of
  ...
  "mleLinRegr"         -> sampleIOFixed (mleLinRegr 2000 40 8) >>= printThenWrite
  ...
  "mleHMM"             -> sampleIOFixed (mleHMM 1000 100 20) >>= printThenWrite
  ...
  "mleLDA"             -> sampleIOFixed (mleLDA 200 20 50) >>= printThenWrite
